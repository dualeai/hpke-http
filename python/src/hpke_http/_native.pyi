...
class Client:
    def __init__(
        ...
        psk: bytes,
        psk_id: bytes,
        limits: tuple[int | None, int | None, int | None, int | None, int | None],
    ) -> None: ...
    def protect(
        self,
        method: str,
    ...
    def begin_stream(
        ...
        path: bytes,
        headers: list[tuple[str, str]],
    ) -> tuple[StreamRequestSealer, bytes]: ...
...
class Server:
    def __init__(
        ...
        recipient_key_id: bytes,
        limits: tuple[int | None, int | None, int | None, int | None, int | None],
        accepted_keys: list[tuple[bytes, bytes]] | None = None,
    ) -> None: ...
    def preparse(self, envelope: bytes) -> PreparsedRequest: ...
    def max_complete_envelope_len(self) -> int: ...
...
class PreparsedStreamRequest:
    @property
    def psk_id(self) -> bytes: ...
    def authenticate(self, server: Server, psk: bytes) -> AuthenticatedStreamRequest: ...
    def discard(self) -> None: ...
...
class AuthenticatedStreamRequest:
    ...
    def admit(self, admitted: bool) -> OpenedStreamRequest: ...
    def discard(self) -> None: ...
...
class OpenedStreamRequest:
    ...
    def finish_eof(self) -> OpenedRequest: ...
    def close(self) -> None: ...
